    ...
    def order(self, side):
        ...
        while True:
            try:
                ...
                has_changed_side = self.__has_changed_side(side=side)
                has_completed_order = size < 0.01 or has_changed_side
        ...
        while True:
            try:
                ...
                if position_side is None \
                    ...
                    message.warning("invalid position")
                    ...
                    message.warning("close invalid position size")
